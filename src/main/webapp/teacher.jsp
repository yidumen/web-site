    ...
    <div id="teacher">
        ...
        <div class="yangning_weixinbox">
            <div class="yangning_weixin">
                <img src="/resources/web/images/qrcode_for_gh_cb255922b43b_258.jpg" width="86"
                     height="86"/>易度门微信公众平台<br/>请使用微信扫描左侧二维码添加，或直接在微信内搜索“易度门”公众帐号进行添加。
            </div>
        </div>
        <p>敬请大家持续关注我们，也请同时关注杨宁老师的新浪微博(<a href="http://www.weibo.com/yidumen" style="font-size:12px; font-family:Arial;">http://www.weibo.com/yidumen</a>)和微信公众平台（<a
                href="javascript:void(0);" onmouseover="$('.yangning_weixinbox').fadeIn('fast');">易度门</a>）。

        </p>
    </div>
    <div id="teacher_weibo_share">
        <iframe width="355" height="550" class="share_self" frameborder="0" scrolling="no"
                src="http://widget.weibo.com/weiboshow/index.php?language=&width=355&height=550&fansRow=1&ptype=1&speed=0&skin=1&isTitle=1&noborder=1&isWeibo=1&isFans=0&uid=2478751807&verifier=4423f2b2&dpc=1"></iframe>
    </div>

</div>
<div id="video_box_large"
     style="width:990px; height:441px;margin-bottom:3em;margin-top:0em;margin-left: auto;margin-right: auto">
