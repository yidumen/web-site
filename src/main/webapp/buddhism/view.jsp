...
<div id="container">
    <div id="General_left">
        ...
        <div id="content_box">
            ...
            <!--next/previous -->
            <dl id="next_prev">
                <dd class="prev" ${prev == null ? 'style="visibility:hidden";' : ''}><a
                        href="/buddhism/${path}/${prev.id}"><span>上一课</span><br/>${prev.title}</a></dd>
                <dt><a href="../${path}">返回目录</a></dt>
                <dd class="next" ${next == null ? 'style="visibility:hidden";' : ''}><a
                        href="/buddhism/${path}/${next.id}"><span>下一课</span><br/>${next.title}</a></dd>
            </dl>
            <!--/next/previous -->
        </div>
    </div>
