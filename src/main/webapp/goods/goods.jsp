        ...
        <div class="goods_index_intro">
            ...
            <div class="goods_index_post">
                <form id="goodsfrm" action="/goods/getbook/process" name="goodsfrm" method="post">
                    ...
                    联系电话：<input type="text" id="telphone" name="telphone" class="goods_input_phone"
                                maxlength="15"/><br/><br/>
                    收件地址： <input type="text" id="address" name="address" class="goods_input_address"
                                 maxlength="100"/><br/>
                </form>
                <div class="zhu">
                    <span>注：</span>
    ...
    <div id="goods_star">
        ...
        <div class="goods_index_intro">
            ...
            <div class="goods_star_list">
                ...
                <span>您也可以直接下载本书电子版本（<a href="http://v3.yidumen.com/doc/星路.pdf">PDF版本</a> | <a
                        href="http://v3.yidumen.com/doc/星路.rtf">RTF版本</a>）</span>
            </div>
        </div>
    </div>
    <div id="goods_music">
