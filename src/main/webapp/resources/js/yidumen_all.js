...
$('li').corner("5px");
$('h3 span').corner("5px");
$('.r_textarea_outer').corner("5px");
$('.r_textarea_inside').corner("5px");
$('#goods_heart').corner("9px");
$('#goods_star').corner("9px");
$('#goods_music').corner("9px");
$('#totalSecond_box').corner("5px");
$('.notification_feedback_contentbox').corner("7px");
$('.notification_large_blue').corner("5px");
