    ...
    <body>
        ...
        <div id="main_container">
            ...
            <div class="mobile_share">
                ...
                <!--腾讯微博 -->
                <a href="javascript:;" class="tmblog" id="share_btn_qq" style="font-size:12px; "> <img src="http://mat1.gtimg.com/app/opent/images/websites/share/weiboicon16.png" border="0" alt="" style="vertical-align:middle; margin-top:-.5em"></a>
            ...
            <div id="content_box">
                <ul>
                    <c:forEach var="item" items="${recommend}">
                        <li>${item.file} <a href="/video/${item.file}">${item.title}</a><span style="background:#dcfe7f;font-size:10px;color:#454545;border-radius:5px;">${item.sort}</span><span class="video_choice" style='background:#FFB6C1;color:#fff;'>荐</span></li>
                            </c:forEach>
